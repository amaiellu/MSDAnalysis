...
def velocityCalcs(mydir,expttag):
        ...
        for file in files:
            ...
            if data.empty:
                ...
                finvelocities=finvelocities.drop(file,0)
                finframes_vs=finframes_vs.drop(file,0)
                finavg_per_frames=finavg_per_frames.drop(file,1)
            else:    
                ...
                if filt_data.empty:
                    ...
                    velocities=ap.abs_velocities(finData,conversion,timescales)
                    ...
                    maxdisps=ap.max_displacement(finData,conversion)
                    ...
                    [avg_particles_frame,hist,velocities_by_frame,pmobile]=ap.vel_frame_by_frame(finData,velocities,maxdisps)
...
velocityCalcs('C:\\Users\\amschaef\\Documents\\Lai Lab\\Salmonella Study\\Bacteria Output\\Individual Movie XY Data\\Compiled Movies','jayframe1')
